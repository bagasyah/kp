...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE laporan SET tanggal='$tanggal', alamat_awal='$alamat_awal', alamat_tujuan='$alamat_tujuan', km_awal='$km_awal', km_akhir='$km_akhir', lampu_depan='$lampu_depan', lampu_sen_depan='$lampu_sen_depan', lampu_sen_belakang='$lampu_sen_belakang', lampu_rem='$lampu_rem', lampu_mundur='$lampu_mundur', bodi='$bodi', ban='$ban', pedal='$pedal', kopling='$kopling', gas_rem='$gas_rem', oli_mesin='$oli_mesin', klakson='$klakson', weaper='$weaper', air_weaper='$air_weaper', air_radiator='$air_radiator', note='$note', tipe_mobil='$tipe_mobil', jenis_perjalanan='$jenis_perjalanan' WHERE id='$id'";
    if ($conn->query($query) === TRUE) {
        header("Location: dashboard.php");
        exit();
    } else {
